"""
Tactical Combat Pistol V9 - Precision Mechanical & Ergonomic Silhouette
- Crisp VECTOR mechanical edges for CNC dust cover, Picatinny rail, and magwell base
- Smooth AUTO ergonomic bezier handles for finger grooves, palm swell, and beavertail
- 26° chevron cocking serrations
- 45° bull-nose slide chamfers
- Threaded barrel with knurled thread protector cap
- 3-dot luminous combat sights
...
def create_materials():
    ...
    bsdf.inputs['Base Color'].default_value = (0.070, 0.075, 0.082, 1.0)
    ...
    # 2. Polymer Frame (Matte charcoal black)
...
def build_unified_frame(materials):
    ...
    # Precise profile coordinates with explicit mechanical vs organic handle types
    # (py, pz, handle_type)
    profile = [
    ...
    # 2. Recess Trigger Guard Sides (narrow from 27mm to 13mm)
    for side in [-1, 1]:
    ...
    # 3. Ergonomic Thumb Rest Indents on Upper Frame (shallow oval)
    for side in [-1, 1]:
...
def main():
    ...
    print("[COMPLETE] Tactical Pistol V9 generation and rendering finished successfully!")
